...
function update(params) {
  ...
  return function (state) {
    ...
    var endpoint = _expandReferences3.endpoint;
...
function update75(params) {
  ...
  return function (state) {
    ...
    var endpoint = _expandReferences4.endpoint;
    var body = _expandReferences4.body;
    ...
    var baseUrl = _state$configuration4.baseUrl;
